...
namespace PLUG_3._0
{
    public partial class Login : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            else if (txtUsername.Text.ToLower() == "219127027" && txtPassword.Text.ToLower() == "1234" && checkBox.Checked && comboBox.Text == "Student")
            {
                this.Hide();
                VerficationStud verification = new VerficationStud();
                verification.Show();
            ...
            else if (txtUsername.Text.ToLower() == "andrew@xtlaproduction.co.za" && txtPassword.Text.ToLower() == "1234" && checkBox.Checked && comboBox.Text == "Sponsor")
            {
                this.Hide();
                Verification verification = new Verification();
                verification.Show();
